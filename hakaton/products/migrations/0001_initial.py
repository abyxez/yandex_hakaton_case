# Generated by Django 3.2.3 on 2023-10-06 09:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(max_length=200, verbose_name='Категория товара')),
                ('subcategory', models.CharField(max_length=200, verbose_name='Подкатегория товара')),
                ('uom', models.IntegerField(verbose_name='Маркер товара -на вес или шт')),
                ('sku', models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.CASCADE, to='products.product', verbose_name='Наименование товара ')),
            ],
            options={
